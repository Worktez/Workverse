...
export class SceneComponent implements OnInit {
  ...
  private createScene() {
    ...
    this.scene.fog = new THREE.Fog(0xa0a0a0, 200, 3000);
    ...
    this.wall1 = new THREE.Mesh(new THREE.BoxGeometry(2000, 2000, 2000), new
      THREE.MeshPhongMaterial({ color: 0x87CEEB, depthWrite: false, side: 2 }));
  ...
  private update() {
    ...
    if (conditions) {
      ...
      var relativeCameraOffset = new THREE.Vector3(0, 200, 650);
