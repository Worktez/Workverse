...
@Component({
  ...
  styleUrls: ['./spartan.component.css']
})
export class SpartanComponent implements OnInit {
  ...
  private createScene() {
    ...
    this.loaderGLTF.load('assets/spartan/scene.gltf', (gltf: GLTF) => {
 ...
 */
  private startRenderingLoop() {
    ...
    let component: SpartanComponent = this;
    (function render() {
